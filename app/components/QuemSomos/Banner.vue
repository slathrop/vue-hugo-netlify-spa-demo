<template>
	<div
		...
		style="top: 0; height: calc(50vh + 50px)"
	>
		<div class="spl-20">
			<div
			...
			>
				<div class="font-200 txt1">QUEM</div>
				<div class="font-800 txt2">SOMOS</div>
			</div>
		</div>
	</div>
</template>
...
<style lang="scss">
	.banner-quem-somos {
		background: linear-gradient(#000000e7, #000000e3),
			url('/pattern-hor.jpg') center / cover;
	}
